...
public class ExternalServiceController {
    ...
    public Mono<ResponseEntity<CardPaymentResponseDto>> makeCardPayment(CardPaymentDetailsDto cardPaymentDetailsDto) {
    ...
    public Mono<ResponseEntity<CreditRatingResponseDto>> getCreditRating(CustomerDto customerDto) {
