...
import com.lkksoftdev.apigateway.dto.ErrorDetails;
import com.lkksoftdev.apigateway.dto.ResponseDto;
...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<ResponseDto> handleMethodArgumentTypeMismatchException(
        ...
        LOGGER.error("Endpoint argument exception occurred: {}", ex.toString());
